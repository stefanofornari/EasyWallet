 ...
 *
 */
public class BaseLedgerManager implements TestingUtils {
    ...
    protected static final Transaction[] TRANSACTIONS1 = new Transaction[] {
        ...
        //       the same timestamp
        //
        new Transaction(new Date(NOW.toEpochMilli()), STORJ, BigDecimal.ONE, ADDRESS1, WALLET1, "block1-hash1"),
    ...
    protected static final Transaction[] TRANSACTIONS2 = new Transaction[] {
        ...
        new Transaction(new Date(NOW.minus(24, ChronoUnit.HOURS).toEpochMilli()), STORJ, BigDecimal.ONE, null, WALLET1, "block2-hash1"), // duplicated
        new Transaction(new Date(NOW.minus(24, ChronoUnit.HOURS).toEpochMilli()), STORJ, BigDecimal.valueOf(1, 50), null, WALLET1, "block2-hash1") // amount too big
    };
